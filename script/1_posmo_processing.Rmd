...
#bus
posmo_test <- posmo |>
  filter(posmo$datetime > as.POSIXct("2023-06-18 12:23:30", tz = "Europe/Zurich") & posmo$datetime < as.POSIXct("2023-06-18 12:29:30", tz = "Europe/Zurich"))
posmo_test
...
posmo_filter <- posmo %>% filter(tmode_manual == "walk") #%>% filter(as.Date(datetime) == "2023-04-15") 
