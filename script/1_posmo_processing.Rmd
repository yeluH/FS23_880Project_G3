...
#bike
posmo_test <- posmo |>
  filter(posmo$datetime > as.POSIXct("2023-05-31 18:09:00", tz = "Europe/Zurich") & posmo$datetime < as.POSIXct("2023-05-31 18:35:00", tz = "Europe/Zurich"))
posmo_test
...
posmo_filter <- posmo %>%
  ...
  filter(tmode_manual == "bike") #%>% filter(as.Date(datetime) == "2023-04-15") 
