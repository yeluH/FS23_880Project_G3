...
# posmo <- read_csv("./data/posmo_2023-06-14_2.csv") %>% st_as_sf(coords = c("lon_x", "lat_y"), crs=4326, 
#                                                                remove = FALSE) |> st_transform(2056)

# working on Yelu's laptop
posmo <- read_csv("D:/GEO880/Project/posmo_2023-06-14_2.csv") %>% st_as_sf(coords = c("lon_x", "lat_y"), crs=4326, 
                                                                remove = FALSE) |> st_transform(2056)
...
# On yelu's laptop
dhm25 <- raster("D:/GEO880/Project/dhm25_raster/dhm25_2056.tif")
...
#-> timelag = 0 -> ok perfect


summary(mvmt_data$stepMean)

ggplot(mvmt_data, aes(stepMean)) +
  geom_histogram(binwidth = 1) +
  geom_vline(xintercept = mean(mvmt_data$stepMean, na.rm = TRUE))
...
=======
    filter(as.Date(datetime) == "2023-04-30")
>>>>>>> 5933929a93e97841781542282b94beba7adf0eee
filter
