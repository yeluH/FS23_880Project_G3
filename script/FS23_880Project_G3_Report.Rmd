...
mvmt_seg_final <- mvmt_data_split %>% 
  dplyr::select(-c("segment_ID_user", "segment_ID_gap", "duration_index", "segment_ID_tmode", "nMinus5", "nMinus4", "nMinus3", "nMinus2", "nMinus1", "nPlus1", "nPlus2", "nPlus3", "nPlus4", "nPlus5"
))
```
...
# Merge all variables
mvmt_all <- merge(st_drop_geometry(mvmt_seg_summary), st_drop_geometry(mvmt_seg_annotations_summarized),
                  by = c('segment_ID_final'))
# ## 1459 RECORDS
# 
# 
