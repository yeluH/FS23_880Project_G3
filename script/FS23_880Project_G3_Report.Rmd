...
```{r add_region, echo = TRUE, warning = FALSE, message = FALSE}
...
Here is the final total of recorded points and the distribution within the mean of transport: 
...
```{r count_points_tot, echo = TRUE, warning = FALSE, message = FALSE}
# Add CH and Kanton borders to understand the map.
ggplot(mvmt_data, aes(E, N, color = source)) +
  geom_point() +
  #geom_path() +
  coord_equal() +
  theme(legend.position = "none") +
  labs(subtitle = "All points")
```

```{r}
#map overview -> too much points = too slow, to remove.
...
#### Pre-segmentation: gap, user and labelized transport mode
