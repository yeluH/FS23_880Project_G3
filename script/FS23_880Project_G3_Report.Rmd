...
#Visualisation of proximity:
visu_true <- mvmt_seg_final |> filter(isClosetoTrams) %>% st_transform(crs = 4326)
visu_false <- mvmt_seg_final |> filter(!isClosetoTrams) %>% st_transform(crs = 4326)
...
<!-- #Visualisation of proximity: -->
<!-- visu_true <- extract_f |> filter(isClosetoTrams) %>% st_transform(crs = 4326) -->
<!-- visu_false <- extract_f |> filter(!isClosetoTrams) %>% st_transform(crs = 4326) -->
