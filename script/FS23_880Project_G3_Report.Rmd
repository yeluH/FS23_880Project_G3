...
The main parameter to set for Knn is "k" the number of neighbours considered. Different sets of number will be tested. Try kv = 5, 11, 50 and 5 is the best Try kv = 3, 4, 5, 7 and 3 is the best Try kv = 1, 2, 3 and 1 is the best
